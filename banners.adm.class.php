...
class Banners extends BannersBase
{
    ...
    protected function validateBannerData($bEdit, array $aDataPrev = array())
    {
        $aData = $this->input->postm(array(
                ...
                'specialization_id' => TYPE_ARRAY_INT, # ID специализаций или 0
        ...
        if (Request::isPOST()) {
            ...
            unset($country_id, $aData['country_id']);
            ...
            $specialization_id = join(',', $specialization_id);
    ...
    protected function validatePositionData($nPositionID, $bSubmit)
    {
        $aData = $this->input->postm(array(
                ...
                'filter_specialization' => TYPE_BOOL, # Специализация
